...
insert into usuario (nombre, apellidos, email, fechaNacimiento, sexo, peso, DNI, secret, salt, estado) values ("Manuel", "Martinez Sanchez", "manuma02@ucm.es", "07/05/1992", 0, 80, "11868634J", "secret", "salt", 1);
...
insert into usuario (nombre, apellidos, email, fechaNacimiento, sexo, peso, DNI, secret, salt, estado) values ("Juan Pedro", "Gutierrez", "jprodriguez@malarm.com", "15/10/1998", 0, 60, "12345678Z", "secret", "salt", 2);
...
insert into usuario (nombre, apellidos, email, fechaNacimiento, sexo, peso, DNI, secret, salt, estado) values ("Paz", "Sanchez Garcia", "pazsanga@gmail.com", "15/02/1962", 1, 47, "50305550L", "secret", "salt", 0);
insert into usuario (nombre, apellidos, email, fechaNacimiento, sexo, peso, DNI, secret, salt, estado) values ("Manuel", "Martinez Zurimendi", "manuelzuri.martinez@ono.es", "02/10/1960", 0, 47, "50301055D", "secret", "salt", 0);
insert into usuario (nombre, apellidos, email, fechaNacimiento, sexo, peso, DNI, secret, salt, estado) values ("Victoria", "Garcia Contreras", "prueba@malarm.com", "24/01/1933", 1, 47, "02162236Y", "secret", "salt", 0);
insert into usuario (nombre, apellidos, email, fechaNacimiento, sexo, peso, DNI, secret, salt, estado) values ("Juan Domingo", "Sanchez Lorenzo", "prueba@malarm.com", "12/11/1934", 0, 47, "00625351G", "secret", "salt", 0);
