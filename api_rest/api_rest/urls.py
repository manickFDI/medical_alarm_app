...
urlpatterns = [
    ...
    url(r'^', include(router.urls)), # Gracias al router las urls se generan automaticamente
    url(r'^api-auth/', include('rest_framework.urls', namespace='rest_framework')) # Es opcional. Nos crea el login default
]
